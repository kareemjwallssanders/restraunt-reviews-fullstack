...
// api ===========================================================================
  ...
  app.post('/api/reviews', upload.array('images', 5), (req, res) => {
    ...
    db.collection('reviews').save({username: req.body.username, images: images, review: req.body.review}, (err, result) => {
      if (err) return console.log(err)
  ...
  app.delete('/api/reviews', (req, res) => {
    db.collection('reviews').findOneAndDelete({_id: ObjectId(req.body._id)}, (err, result) => {
      if (err) return console.log(err)
      res.send(result)
    })
  });  
